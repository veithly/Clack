...
<img src="./public/screenshots/home-hero.png" alt="Clack 首页真实截图" width="100%" />
...
[在线演示](https://clack.veithly.workers.dev) ·
[本地运行](#本地运行) ·
[检查结果](#运行后检查什么) ·
...
<table>
  <tr>
    <td width="50%"><img src="./public/screenshots/result-yellow.png" alt="42 分黄灯报告真实截图" /></td>
    <td width="50%"><img src="./public/screenshots/result-green.png" alt="78 分绿灯报告真实截图" /></td>
  </tr>
  <tr>
    <td>初始样例先给出 42 分黄灯和 3 个证据缺口。</td>
    <td>补充项目复盘材料后，报告刷新到 78 分绿灯。</td>
  </tr>
  <tr>
    <td width="50%"><img src="./public/screenshots/card-desktop.png" alt="只读证据卡真实截图" /></td>
    <td width="50%"><img src="./public/screenshots/trace-desktop.png" alt="Agent Trace 真实截图" /></td>
  </tr>
  <tr>
    <td>只读证据卡保留候选人授权边界。</td>
    <td>Agent Trace 展示每一步输入、输出和规则兜底。</td>
  </tr>
</table>
...
public/screenshots/               README 使用的真实产品截图
public/art/                       产品页背景和视觉资源
public/brand/                     品牌图形资源
