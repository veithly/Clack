...
"[project]/src/components/trace-client.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const TraceClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call TraceClient() from the server but TraceClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/trace-client.tsx <module evaluation>", "TraceClient");
}),
"[project]/src/components/trace-client.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const TraceClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call TraceClient() from the server but TraceClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/trace-client.tsx", "TraceClient");
}),
"[project]/src/components/trace-client.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$trace$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/trace-client.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$trace$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/components/trace-client.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$trace$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/src/lib/ai-provider.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getOpenAIClient() {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__["default"]({
...
"[project]/src/lib/ai-report.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$provider$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-provider.ts [app-rsc] (ecmascript)");
;
;
...
async function requestAnalysis(systemPrompt, userPrompt, allowProven) {
    const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$provider$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getOpenAIClient"])();
    if (!client) return null;
    try {
        const response = await client.chat.completions.create({
            model: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$provider$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDefaultAiModel"])(),
            temperature: 0.2,
            response_format: {
                type: "json_object"
            },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$report$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-report.ts [app-rsc] (ecmascript)");
;
;
;
;
...
async function getD1() {
    try {
        const context = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opennextjs$2f$cloudflare$2f$dist$2f$api$2f$cloudflare$2d$context$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCloudflareContext"])({
            async: true
        });
...
async function createReport(input) {
    ...
    const ai = input.useSample ? null : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$report$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["analyzeInitialReport"])({
        jdText,
        resumeText,
        evidenceText
    });
...
async function addEvidence(id, input) {
    ...
    const ai = isSampleReport ? null : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$report$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["analyzeEvidenceUpdate"])({
        report,
        evidenceText
    });
...
"[project]/src/app/trace/[id]/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$trace$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/trace-client.tsx [app-rsc] (ecmascript)");
...
async function Page({ params }) {
    ...
    const report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getReport"])(id);
    const trace = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTrace"])(id);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$trace$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TraceClient"], {
                initialTrace: trace,
                report: report,
                reportId: id
            }, void 0, false, {
                fileName: "[project]/src/app/trace/[id]/page.tsx",
                lineNumber: 10,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        "data-placeholder-example": "输入摘要示例",
                        children: "读取岗位要求和简历声明"
                    }, void 0, false, {
                        fileName: "[project]/src/app/trace/[id]/page.tsx",
                        lineNumber: 12,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        "data-placeholder-example": "输出摘要示例",
                        children: "评分更新为 78 分"
                    }, void 0, false, {
                        fileName: "[project]/src/app/trace/[id]/page.tsx",
                        lineNumber: 13,
...
"[project]/src/app/trace/[id]/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/trace/[id]/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1oge9pq._.js.map