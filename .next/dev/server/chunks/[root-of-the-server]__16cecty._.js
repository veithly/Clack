...
;
;
const DB_PATH = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])(process.cwd(), ".data", "reports.sqlite");
let db = null;
...
function getDb() {
    if (db) return db;
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["mkdirSync"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(DB_PATH), {
        recursive: true
    });
    const nextDb = new __TURBOPACK__url__external__node$3a$sqlite__["DatabaseSync"](DB_PATH);
    nextDb.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_reports_owner ON reports(ownerId, updatedAt);
    CREATE INDEX IF NOT EXISTS idx_reports_session ON reports(sessionId, updatedAt);
  `);
    db = nextDb;
    return nextDb;
}
function saveReport(report) {
    ...
    `).run(report.id, report.sessionId, report.ownerId, report.shareToken, report.role, JSON.stringify(report), report.createdAt, report.updatedAt);
}
...
function makeCard(reportId, shareToken, version, score, light) {
...
async function getReport(id) {
    const row = getDb().prepare("SELECT report_json FROM reports WHERE id = ?").get(id);
...
"[project]/src/app/api/report/[id]/evidence/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    ...
    const report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addEvidence"])(id, input);
    if (!report) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16cecty._.js.map